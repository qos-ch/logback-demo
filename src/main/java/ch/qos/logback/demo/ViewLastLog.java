...
public class ViewLastLog extends HttpServlet  {
  ...
  HTMLLayout layout;
  static String PATTERN = "%d%thread%level%logger{25}%mdc{" + Constants.USERID_MDC_KEY
      + "}%msg";
  ...
  void reacquireCBA() {
    ...
    cyclicBufferAppender = (CyclicBufferAppender) context.getLogger(
        LoggerContext.ROOT_NAME).getAppender(CYCLIC_BUFFER_APPENDER_NAME);
  }
  protected void service(HttpServletRequest req, HttpServletResponse resp)
    ...
    output
        .append("<tr><td class=\"sexy\"><a href=\"" + localRef + "/index.jsp\" class=\"sexy\">Main Page</a></td></tr>");
    output
